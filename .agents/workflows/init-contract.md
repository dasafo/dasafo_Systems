...
3. **Run PRP Generator:** `python3 dasafo_FACTORY/skill_engine.py --agent PRODUCT_OWNER --skill prp-generator --target-project $TARGET_PROJECT --input '{"action": "generate_master", "project_name": "Current Project", "problem_description": "Define based on conversation."}'`
