...
3. **Delegate Action:** `python3 dasafo_Systems/dasafo_FACTORY/skill_engine.py --agent ORCHESTRATOR --skill delegate-clean-session --target-project $TARGET_PROJECT --isolate --input '{"agent_type": "BACKEND_DEV", "spec_path": "TASKS/SPEC_LITE.json"}'`
