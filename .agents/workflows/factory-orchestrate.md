---
description: description: The factory's master command. Analyzes project state and advances to the next phase following the Universal Pipeline (v3.4.0-S).
---
...
3. **Run Scan**: Execute the following command:
   `python3 dasafo_Systems/dasafo_FACTORY/skill_engine.py --agent ORCHESTRATOR --skill agentic-thought-secret-scanner --target-project $TARGET_PROJECT`
