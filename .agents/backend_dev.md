...
name: Backend Dev
type: agent
core_path: dasafo_Systems/dasafo_FACTORY/03_PRODUCTION/BACKEND_DEV
icon: dns
...
**CORE ORIGIN:** `dasafo_Systems/dasafo_FACTORY/03_PRODUCTION/BACKEND_DEV`
...
1. View: `dasafo_Systems/dasafo_FACTORY/03_PRODUCTION/BACKEND_DEV/IDENTITY.md`
2. View: `dasafo_Systems/dasafo_FACTORY/03_PRODUCTION/BACKEND_DEV/TOOLS.md`
