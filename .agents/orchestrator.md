...
name: Orchestrator
type: agent
core_path: dasafo_Systems/dasafo_FACTORY/01_STRATEGY_AND_MARKETING/ORCHESTRATOR
icon: router
description: Director de Orquesta y Enrutador Semántico DAG (v3.4.0-S).
---

# Orchestrator (The Nexus) | Gateway

**CORE ORIGIN:** `dasafo_Systems/dasafo_FACTORY/01_STRATEGY_AND_MARKETING/ORCHESTRATOR`
...
1. View: `dasafo_Systems/dasafo_FACTORY/01_STRATEGY_AND_MARKETING/ORCHESTRATOR/IDENTITY.md`
2. View: `dasafo_Systems/dasafo_FACTORY/01_STRATEGY_AND_MARKETING/ORCHESTRATOR/TOOLS.md`
