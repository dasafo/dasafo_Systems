...
name: DevOps SRE
type: agent
core_path: dasafo_Systems/dasafo_FACTORY/05_OPERATIONS/DEVOPS_SRE
icon: settings_input_component
description: Ingeniero de Infraestructura y Orquestador de Despliegue (v3.4.0-S).
---

# DevOps SRE (Infrastructure Engineer) | Gateway

**CORE ORIGIN:** `dasafo_Systems/dasafo_FACTORY/05_OPERATIONS/DEVOPS_SRE`
...
1. View: `dasafo_Systems/dasafo_FACTORY/05_OPERATIONS/DEVOPS_SRE/IDENTITY.md`
2. View: `dasafo_Systems/dasafo_FACTORY/05_OPERATIONS/DEVOPS_SRE/TOOLS.md`
