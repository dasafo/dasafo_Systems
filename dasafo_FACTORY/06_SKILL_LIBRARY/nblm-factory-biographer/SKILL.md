...
- **Artifact Ingestion:** Reports MUST be based on physical logs collected from `LOGS/`. Hallucinating progress without reading physical artifacts is strictly FORBIDDEN.
- **Traceability:** The final biography artifact MUST be referenced via a verifiable URL or a physical backup path.
