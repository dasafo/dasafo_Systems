...
- **API Lock:** Requires `APIFY_API_TOKEN`. Returning "simulated trends" without a live actor run is FORBIDDEN.
- **Persistence:** Raw results must be physically saved to `/trends/` before result processing.
