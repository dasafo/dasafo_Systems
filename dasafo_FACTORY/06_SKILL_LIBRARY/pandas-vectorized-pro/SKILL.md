...
- **Physical Load:** REQUIRES valid CSV/Parquet target on disk. Generating stats for non-existent datasets results in skill failure.
- **Optimization Audit:** Every transformation MUST report memory saved in bytes (SI) via physical profiling of the Pandas object.
