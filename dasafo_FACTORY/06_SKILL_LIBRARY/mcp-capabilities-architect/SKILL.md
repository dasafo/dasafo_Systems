...
- **Standard Compliance:** Proposals MUST strictly follow the MCP specification. Any deviation from the protocol is categorized as a system failure.
- **Physical Traceability:** A proposal must be physically written to `DOCS/PROPOSALS/` to be considered `success`.
