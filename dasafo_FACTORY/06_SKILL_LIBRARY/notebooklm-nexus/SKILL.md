...
- **Source Provenance:** Synthesis MUST trace insights back to physical PDFs/Markdown artifacts. Hallucinated correlations without a source citation are strictly FORBIDDEN.
- **Physical Export:** Final findings MUST be physically persisted to `$TARGET_PROJECT/LOCAL_KNOWLEDGE/synthesis/`.
