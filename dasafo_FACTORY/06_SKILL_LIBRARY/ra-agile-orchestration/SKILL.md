...
- **Physical Dispatch:** Agent assignments MUST be recorded in the physical `SQUAD_ORCHESTRATION.json`.
- **Constraint Compliance:** RA-levels MUST be physically audited against the task's DoD before parallelization is allowed.
