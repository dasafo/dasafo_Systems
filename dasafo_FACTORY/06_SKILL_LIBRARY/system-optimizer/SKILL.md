...
- **Evidence Based:** Efficiency gains MUST be backed by physical orchestration logs. Hallucinating model "speedups" is FORBIDDEN.
- **Physical Report:** Optimizations MUST result in a physical Markdown report saved in `ANALYSIS/optimization/`.
