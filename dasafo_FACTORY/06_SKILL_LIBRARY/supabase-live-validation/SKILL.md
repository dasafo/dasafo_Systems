...
- **Drift Zero:** Any detected table column or type mismatch MUST result in a `BLOCK_DEPLOYMENT` verdict.
- **Physical Verification:** Validation MUST include a physical test of RLS policies for a mock industrial user.
