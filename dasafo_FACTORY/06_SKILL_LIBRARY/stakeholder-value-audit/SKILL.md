...
- **Evidence Lock:** Rejections MUST point to a specific "Fiction" pattern defined in `GLOBAL_KNOWLEDGE`.
- **Physical Trace:** Audits MUST be physically logged in `$TARGET_PROJECT/LOGS/strategy_audit.log` for future SRE review.
