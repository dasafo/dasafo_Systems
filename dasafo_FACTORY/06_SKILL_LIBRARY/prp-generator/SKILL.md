...
- **Blueprint Persistence:** Contracts MUST be physically versioned in `LOCAL_KNOWLEDGE/contracts/`. Mocks are detected via missing file timestamps.
- **Audit Requirement:** All blueprints MUST include a physical `SOLIDITY_AUDIT` marker for downstream gates.
