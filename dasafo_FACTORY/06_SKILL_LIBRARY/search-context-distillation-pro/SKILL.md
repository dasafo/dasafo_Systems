...
- **Cognitive Preservation:** Every distilled fact MUST reference its physical source line number in the original log.
- **Verification:** Facts are validated against a checksum of the original log before rotation.
