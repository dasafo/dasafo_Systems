...
def get_pro_docs(spec: dict, include_examples: bool = True) -> str:
    ...
    desc = info.get("description", "Comprehensive API documentation generated by Dasafo Architect (v4.0-S).")
    ...
    md += "## 📐 Industrial Compliance (Sistema Internacional)\n\nDe acuerdo con el mandato **v4.0-S**, todas las métricas operativas de esta API se expresan bajo el **SI**.\n\n*Generated by Agentic Documentation Engine (v4.0-S)*"
    return md
...
def run(skill_input: SkillInput) -> SkillOutput:
    ...
    try:
        ...
        # 6. Result Building (v4.0-S Schema Compliance)
