...
def get_pro_docs(spec: dict, include_examples: bool = True) -> str:
    ...
    desc = info.get("description", "Comprehensive API documentation generated by Dasafo Architect (v3.3.0-S).")
    ...
    md += "De acuerdo con el mandato **v3.3.0-S**, todas las métricas operativas de esta API se expresan bajo el **Sistema Internacional d'Unitats (SI)**:\n"
    ...
    md += "\n\n*Generated by Agentic Documentation Engine (v3.3.0-S) | Source: sickn33/api-documentation-generator*"
    return md
