...
- **Physical Parsing:** This skill is physically locked if `DOCS/API-CONTRACT.yaml` is missing. It MUST read and parse the physical YAML on disk to generate documentation.
- **Reference Integrity:** Links generated in markdown must be physically verified against the project's folder structure.
...
4. **Output:** Write to physical file `$TARGET_PROJECT/DOCS/API_REFERENCE.md`.
