...
- **Auditability:** Every intercepted exception MUST be physically logged with a unique UUID in `LOGS/errors.log`.
- **Zero Hallucination:** Error messages presented to the user MUST be physically mapped to a known industrial error code.
