...
- **Feedback Evidence:** Optimizations MUST be based on physical log entries from `FEEDBACK-LOG.md`. Hallucinating "improvements" without evidence is FORBIDDEN.
- **Solidity Lock:** YAML versioning MUST be incremented only after a physical lint pass (markdownlint).
