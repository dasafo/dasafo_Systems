...
- **Source Integrity:** Only exports physical artifacts (PDF/Text). Simulated memory syncs without a physical source export are FORBIDDEN.
- **Version Control:** Sprints and Dates MUST be physically tagged in the source metadata for chronological auditability.
