...
class {domain.capitalize()}Service:
    \"\"\" Business logic for {domain} (v4.0-MCP) \"\"\"
...
def run(skill_input: SkillInput) -> SkillOutput:
    """Industrial Entry Point for FastAPI Backend Logic (v4.0-MCP)."""
    ...
    try:
        ...
        if action == "scaffold":
            ...
            files = {
                ...
                "models.py": "# SQLAlchemy Models (v4.0-MCP)\n",
