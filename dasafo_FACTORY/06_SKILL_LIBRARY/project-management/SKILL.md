...
- **Physical Registry:** Task counts MUST match the absolute number of `TSK_` JSON files in the filesystem. Hallucinating an "organized" state without physical artifacts is FORBIDDEN.
- **Traceability:** Every task generated must be linked to a physical PRP or Architecture requirement.
