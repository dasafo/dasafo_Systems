...
def run(skill_input: SkillInput) -> SkillOutput:
    ...
    try:
        ...
        if action == "standup_report":
            ...
            report_content = (
                f"# Stark-Standup (v4.0-MCP) | CID: {cid}\n\n"
                ...
                "\n*Generated by PM Engine (v4.0-MCP) using Physical Evidence.*"
            )
            ...
            summary_msg = "Project status logged to physical JSON artifact."
             ...
             return SkillOutput.failure(agent, skill, f"PM action '{action}' not implemented in v4.0-MCP.", cid)
