...
- **Physical Load:** REQUIRES valid CSV/Parquet target on disk. Generating statistics for non-existent datasets results in skill failure.
- **Reproducibility:** EDA reports MUST include the SHA-256 of the source dataset for scientific lineage.
