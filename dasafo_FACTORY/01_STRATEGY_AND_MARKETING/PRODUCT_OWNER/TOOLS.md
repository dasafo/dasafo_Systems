...
- **DAST Sense:** Capacidad para verificar la presencia física de requerimientos iniciales en `TASKS/01_PENDING/` antes de generar el contrato.
- **Registry Sense:** Direct interaction with `PROJECT_STATE.json` to sign off Phase M1.
