...
- **Filesystem Sense:** Read and modify test suites and reports in `$TARGET_PROJECT/WORKSPACE/tests/`.
- **Terminal Sense:** Execution of test runners (`pytest`, `jest`, `playwright`) and linters.
- **Search Sense:** Scan for undocumented features or missing test coverage.
...
---
*QA Tester v3.2.5-S | Status: Encapsulated & Modularized.*
