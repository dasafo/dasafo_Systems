...
3. **Causality Check:** Determine if a failure is due to poor prompting, bad tools, or architectural flaws.
4. **Automated Fix:** If the solution is clear, propose an update to the corresponding `SKILL.md` or `IDENTITY.md`.
