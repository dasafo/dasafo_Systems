...
- **Health Pulse:** Monitor the `dasafo-health-monitor` (Port 61208) before launching new projects.
- **Self-Healing Deployment:** Verify the `INFRA` daemon pulse before project initialization.
- **v3.1 Governance:** Enforce `dasafo_network` isolation and Docker resource quotas.
